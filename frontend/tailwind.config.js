  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        referenceHeading: ['var(--astrea-heading-font)', '-apple-system', 'BlinkMacSystemFont', '"Segoe UI"', 'Arial', 'sans-serif'],
        referenceBody: ['var(--astrea-body-font)', '-apple-system', 'BlinkMacSystemFont', '"Segoe UI"', 'Arial', 'sans-serif'],
      },
      boxShadow: {
