...
export function CandidatePage() {
  return (
    <>
      ...
      <Section>
        <form className="mx-auto max-w-4xl space-y-10" onSubmit={(event) => event.preventDefault()} noValidate>
          <fieldset className="border-t border-brand-gray10/30 pt-8">
            <legend className="font-display text-3xl">Анкета кандидата</legend>
          ...
          <fieldset className="border-t border-brand-gray10/30 pt-8">
            <legend className="font-display text-3xl">Обращение</legend>
          ...
          <fieldset className="border-t border-brand-gray10/30 pt-8">
            <legend className="font-display text-3xl">Фотография</legend>
            <div className="mt-6 border border-dashed border-brand-gray10/50 bg-white/60 px-6 py-8">
          ...
          <fieldset className="border-t border-brand-gray10/30 pt-8">
            <legend className="font-display text-3xl">Подтверждения</legend>
          ...
          <div className="border-t border-brand-gray10/30 pt-8">
